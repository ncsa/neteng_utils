...
class EnsureAllVLANsInDefaultGroup(Script):
    ...
    class Meta:
        ...
        description = "Assign every VLAN to the VLAN Group with the given slug (default: 'DEFAULT_VLAN_GROUP')."
    ...
    def _prettify_slug(self, slug: str) -> str:
        # Turn "DEFAULT_VLAN" -> "Default Vlan Group"
